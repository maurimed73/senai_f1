...
import 'package:senai_f1/screens/GestaoProjeto/campeonato/gestao_tarefa.dart';
...
class GarrafasGestao extends StatefulWidget {
  String campeonato;
  GarrafasGestao({super.key, required this.campeonato});
  @override
...
class _GarrafasGestaoState extends State<GarrafasGestao> {
  ...
  refresh() async {
    ...
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await firestore.collection("TarefasGestao${widget.campeonato}").get();
                        ...
                        onPressed: () async {
                          ...
                          try {
                            ...
                            await FirebaseFirestore.instance
                                .collection('TarefasGestao${widget.campeonato}')
