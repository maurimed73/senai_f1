...
import 'package:senai_f1/screens/GestaoProjeto/campeonato/gestao_grid_garrafas5.dart';
...
class GestaoProjetos extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();
  final context;
  final campeonato;
  const GestaoProjetos({super.key, this.context, this.campeonato});

  @override
  State<GestaoProjetos> createState() => _GestaoProjetosState();
}

class _GestaoProjetosState extends State<GestaoProjetos> {
  ...
  void atualizarGarrafasTerminadas() async {
    ...
    int resultado = await projetoService.numeroGarrafasTerminadas(
        'TarefasGestao', widget.campeonato);
