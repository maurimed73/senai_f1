...
import 'package:senai_f1/screens/Empreendimento/empreendimento_menu.dart';
...
class reg_nac_Empreendimento extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();

  const reg_nac_Empreendimento({super.key});

  @override
  State<reg_nac_Empreendimento> createState() => _reg_nac_EmpreendimentoState();
}

// ignore: camel_case_types
class _reg_nac_EmpreendimentoState extends State<reg_nac_Empreendimento> {
