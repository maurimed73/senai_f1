...
class ReciclagemEmpreendimento extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();

  ReciclagemEmpreendimento({super.key});

  @override
  State<ReciclagemEmpreendimento> createState() =>
      _ReciclagemEmpreendimentoState();
}

class _ReciclagemEmpreendimentoState extends State<ReciclagemEmpreendimento> {
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            mesGrafico(colorDart: colorDart, mes: 'DEZEMBRO'),
                          ],
                        ),
                        const SizedBox(
                          height: 20,
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            mesGrafico(colorDart: colorDart, mes: 'JANEIRO'),
                            mesGrafico(colorDart: colorDart, mes: 'FEVEREIRO'),
                            mesGrafico(colorDart: colorDart, mes: 'MARÇO'),
                            Container(
                                height: 30,
                                color: Colors.transparent,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text('GERAL- GESTÃO DE PROJETOS'),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text('GERAL - TODAS AS ÁREAS'),
                              style: ElevatedButton.styleFrom(
                                foregroundColor: Colors.white,
                                backgroundColor:
                                    colorDart.VermelhoPadrao, // Cor do texto
