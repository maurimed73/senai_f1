...
import 'package:senai_f1/screens/Empreendimento/campeonato/empreendimento_grid_garrafas5.dart';
...
class EmpreendimentoProjetos extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();
  final context;
  final campeonato;
  const EmpreendimentoProjetos({super.key, this.context, this.campeonato});

  @override
  State<EmpreendimentoProjetos> createState() => _EmpreendimentoProjetosState();
}

class _EmpreendimentoProjetosState extends State<EmpreendimentoProjetos> {
  AuthService serviceAuth = AuthService();

  ColorsDart colorDart = ColorsDart();

  //CLIQUEI NO ITEM PARA ALTERAÇÕES DE DATA E NOME DO RESPONSÁVEL
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // GARRAFAS DE TAREFAS E GARRAFA COM +
                  Padding(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => ReciclagemRegional(
                                        titulo: AppLocalizations.of(context)!
                                            .enterprise,
                                        banco: "TarefasEmpreendimentoRegional",
                                      ),
                                    ))
                                : campeonato == "Nacional"
                                    ? Navigator.push(
