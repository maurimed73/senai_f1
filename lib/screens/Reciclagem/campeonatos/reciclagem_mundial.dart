...
class ReciclagemMundial extends StatefulWidget {
  final String banco;
  final String titulo;
  const ReciclagemMundial({super.key, required this.banco, required this.titulo});

  @override
  State<ReciclagemMundial> createState() => _ReciclagemMundialState();
}

class _ReciclagemMundialState extends State<ReciclagemMundial> {
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        color: Colors.white,
                                        fontFamily: 'Poppins',
                                        fontSize: larguraTela < 390 ? 30 : 40),
