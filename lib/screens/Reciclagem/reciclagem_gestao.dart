...
class ReciclagemGestao extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();

  ReciclagemGestao({super.key});

  @override
  State<ReciclagemGestao> createState() => _ReciclagemGestaoState();
}

class _ReciclagemGestaoState extends State<ReciclagemGestao> {
