...
import 'package:senai_f1/screens/GestaoProjeto/campeonato/gestao_projetos.dart';
...
class GestaoMenu extends StatefulWidget {
  ...
  const GestaoMenu({super.key, required this.campeonato});
...
// Função que exibe o AlertDialog
  ...
  Widget build(BuildContext context) {
    print('Entrando no menu Gestao ${widget.campeonato}');
