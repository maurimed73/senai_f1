...
class EmpreendimentoMenu extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();
  final String campeonato;
  const EmpreendimentoMenu({super.key, required this.campeonato});

  @override
  State<EmpreendimentoMenu> createState() => _EmpreendimentoMenuState();
}

// ignore: camel_case_types
class _EmpreendimentoMenuState extends State<EmpreendimentoMenu> {
...
// Função que exibe o AlertDialog
  ...
  Widget build(BuildContext context) {
    print('Entrando no menu Empreendimento ${widget.campeonato}');
