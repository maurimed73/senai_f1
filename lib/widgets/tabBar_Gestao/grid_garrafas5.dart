...
class Garrafas5 extends StatefulWidget {
  @override
  State<Garrafas5> createState() => _Garrafas5State();
}

class _Garrafas5State extends State<Garrafas5> {
...
// Função de validação
  ...
  Widget build(BuildContext context) {
    ...
    final projetos = Provider.of<MainModel>(context).projetos;
    ...
    return Consumer<MainModel>(builder: (context, projetoProvider, child) {
