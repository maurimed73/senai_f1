...
import 'package:senai_f1/screens/GestaoProjeto/gestao_menu.dart';
...
class reg_nac_Gestao extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();

  const reg_nac_Gestao({super.key});

  @override
  State<reg_nac_Gestao> createState() => _reg_nac_GestaoState();
}

// ignore: camel_case_types
class _reg_nac_GestaoState extends State<reg_nac_Gestao> {
...
// Função que exibe o AlertDialog
  ...
  Widget build(BuildContext context) {
    ...
    print('${alturaTela} x ${larguraTela} ');
                              ...
                              Container(
                                ...
                                child: Text(
                                  AppLocalizations.of(context)!
                                      .projectmanagement,
                                  style: TextStyle(
                                      fontSize: larguraTela > 400 ? 52 : 45,
