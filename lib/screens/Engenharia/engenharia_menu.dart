...
import 'package:senai_f1/screens/Engenharia/campeonato/engenharia_projetos.dart';
...
class EngenhariaMenu extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();
  final String campeonato;
  const EngenhariaMenu({super.key, required this.campeonato});

  @override
  State<EngenhariaMenu> createState() => _EngenhariaMenuState();
}

// ignore: camel_case_types
class _EngenhariaMenuState extends State<EngenhariaMenu> {
...
// Função que exibe o AlertDialog
  ...
  Widget build(BuildContext context) {
    print('Entrando no menu Engenharia ${widget.campeonato}');
