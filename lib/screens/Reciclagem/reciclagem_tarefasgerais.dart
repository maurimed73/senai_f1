...
class ReciclagemTarefasGerais extends StatefulWidget {
  // ServiceGestao service = ServiceGestao();

  ReciclagemTarefasGerais({super.key});

  @override
  State<ReciclagemTarefasGerais> createState() =>
      _ReciclagemTarefasGeraisState();
}

class _ReciclagemTarefasGeraisState extends State<ReciclagemTarefasGerais> {
